...
```{r}
slamMatches$WRank <- as.numeric(slamMatches$WRank)
slamMatches$LRank <- as.numeric(slamMatches$LRank)
...
slamMatches <- slamMatches %>%
  ...
  select(Tournament, Date, Surface, Round, Winner, Loser, WRank, LRank, Differential, W1, L1, W2, L2, W3, L3, W4, L4, W5, L5, Wsets, Lsets, Wgames, Lgames) 
slamMatches %>% slice(1:10)
```
