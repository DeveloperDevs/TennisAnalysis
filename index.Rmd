...
dominant %>% select(Player, DominantWins)
```

Let's briefly analyze this table:

- Nadal is the player with the most dominant wins
- Federer, despite having more matches on his belt, still has less dominant wins than Nadal.
