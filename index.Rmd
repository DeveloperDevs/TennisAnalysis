...
Now, we need to split the prepped data into training and testing subsets. We can use sample_frac to get 35% of this data. Learn more about sample_frac here:
...
Let's analyze exactly what this is:


Now, we need to make predictions based on BOTH the training data and test data.
