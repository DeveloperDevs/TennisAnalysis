...
It's important to note two small things that our machine learning is missing at the moment: Court surfaces and current player form. It will be difficult to look at current player for due to the lack of a more recent dataset, but we could look at court surfaces as a factor to fuel our predictions; this will be included in the next update.